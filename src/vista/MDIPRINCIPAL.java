...
public class MDIPRINCIPAL extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        JIFSESION formSesion=new JIFSESION();
        formSesion.setResizable(true);
        formSesion.setMaximizable(true);
        formSesion.setIconifiable(true);
        formSesion.setClosable(true);
        desktopPane.add(formSesion);
